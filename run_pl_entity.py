...
from utils_entity import EntityClassificationTask
...
class NERTransformer(BaseTransformer):
    ...
    def __init__(self, hparams):
        ...
        # module = import_module("tasks_entity")
        # try:
        #     token_classification_task_clazz = getattr(module, hparams.task_type)
        #     self.token_classification_task: EntityClassificationTask = token_classification_task_clazz()
        # except AttributeError:
        #     raise ValueError(
        #         f"Task {hparams.task_type} needs to be defined as a EntityClassificationTask subclass in {module}. "
        #         f"Available tasks classes are: {EntityClassificationTask.__subclasses__()}"
        #     )
